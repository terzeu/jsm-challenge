describe('Home page actions', () => {
  ...
  it('visit detail page on card', () => {
    ...
    cy.get('.member-detail__value').first().should('be.visible')
  })
  ...
  it('filtering by state', () => {
    ...
    cy.get('.checkbox-filter__input-group')
      .first()
